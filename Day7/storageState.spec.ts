...
test("Learn Playwright Locators getByRole()",async ({page}) => {
  ...
  //  await page.locator("").fill("") // xpath or css locators
    ...
    await page.getByRole("textbox",{name:"Username"}).fill("suryaanandasundaram.df93405f59ff@agentforce.com") // playwright locators
   
    await page.getByRole("textbox",{name:"Password"}).fill("Surya@123");
